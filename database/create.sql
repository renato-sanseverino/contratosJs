...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`indicesReajuste` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`contrato` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`tipoContrato` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`subContrato` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`itens` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`login` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`historico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`contador` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`bonus` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`cobranca` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`origemLeitura` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`formaLeitura` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`chamadoServico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`pedidoConsumivel` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`leitura` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`tipoInsumo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`insumo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`despesaChamado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`smtpServer` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`mailing` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`faturamento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`pedidoPecaReposicao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`solicitacaoItem` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`custoIndireto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`despesaDistribuida` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`funcionalidade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`autorizacao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`config` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`itemFaturamento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`reajusteContrato` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`fabricante` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`modeloEquipamento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`regraComissaoVolume` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`regraComissaoAssinatura` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`ativoFixo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`depreciacao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`estatisticaAtendimento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`equipamento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `addOnContratos`.`acessorios` ;
...
START TRANSACTION;
USE `addOnContratos`;
INSERT INTO `addOnContratos`.`equipamento` (`id`, `manufacturerSN`, `internalSN`, `itemCode`, `itemName`, `customer`, `custmrName`, `contactPerson`, `addressType`, `street`, `streetNo`, `building`, `zip`, `block`, `city`, `state`, `country`, `instLocation`, `status`, `installationDate`, `installationDocNum`, `counterInitialVal`, `removalDate`, `removalDocNum`, `counterFinalVal`, `modelo`, `capacidade`, `sla`, `vendedor`, `instaladoPor`) VALUES (1, '2', '3', '4', '5', '6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
